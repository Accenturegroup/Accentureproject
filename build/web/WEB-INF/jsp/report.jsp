...
<html>
   ...
   <title>bootstrap datepicker examples</title>
    ...
    <link href="customize-template.css" type="text/css" media="screen, projection" rel="stylesheet" />
...
<script type="text/javascript">
    ...
    function drawVisualization() {
        ...
        <script src="jquery/jquery-chosen.js" type="text/javascript" ></script>
        <script src="jquery/virtual-tour.js" type="text/javascript" ></script>
        <script type="text/javascript">
        $(function() {
